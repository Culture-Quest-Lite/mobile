      ...
      >
        <View className="flex-row items-center justify-between px-5 py-3">
          ...
          <View className="flex-1 items-center px-3">
            <Text className="text-center text-[18px] font-extralight text-[#2F242C]">
        ...
        >
          <View>
            <View className="flex-row items-center">
              ...
              <View className="ml-3 flex-1">
                <View className="flex-row items-center gap-2">
                  ...
                  <View className="rounded-full bg-[#FFF0F6] px-2.5 py-1">
                    <Text className="text-[11px] font-black uppercase tracking-[0.8px] text-[#EB489B]">
                      Hotspot
                    </Text>
                  </View>
                </View>
                <Text className="mt-1 text-[12px] font-semibold uppercase tracking-[1px] text-[#8A736A]">
                  Người chia sẻ
                </Text>
              </View>
            </View>

            <Text className="mt-4 text-[28px] font-black leading-[32px] text-[#2F242C]">
              {resolvedHotspotTitle}
            </Text>
            <Text className="mt-0.5 text-[14px] leading-5 text-[#7E6F82]">
              Thêm ảnh, video và ghi lại cảm nhận ngắn của bạn sau khi tham
              quan.
            </Text>

            <View
              className="mt-4 rounded-[24px] border border-[#F1E4EC] bg-[#FFF9FD] px-4 py-4"
            ...
            <View className="mt-5 flex-row items-center justify-between">
              <Text className="text-[12px] font-black uppercase tracking-[1px] text-[#8A736A]">
                Phương tiện
              </Text>
              <Text className="text-[12px] font-medium text-[#A897B2]">
            ...
            <View
              className="mt-3 rounded-[24px] border border-dashed border-[#D9D4DD] bg-[#FAF7FB] px-4 py-4"
              style={{ minHeight: 190 }}
            >
              {selectedMedia.length > 0 ? (
                ...
                <View className="flex-1 items-center justify-center px-5">
                  ...
                  <Text className="mt-4 text-center text-[14px] font-medium leading-6 text-[#8A7B83]">
