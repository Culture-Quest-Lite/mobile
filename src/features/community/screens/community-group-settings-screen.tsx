      ...
      >
        ...
        <FieldShell>
          ...
          <TextInput
            ...
            placeholder={t("community.groupSettings.groupNamePlaceholder")}
        ...
        <View className="mt-4">
          <FieldShell>
            <Text
              ...
              style={{ color: palette.mutedText, lineHeight: bodyLineHeightFor(12) }}
            >
              {t("community.groupSettings.requiredApprovalLabel")}
            </Text>
            <View className="mt-3 flex-row gap-2">
              <ApprovalChip
                active={editableRequiredApproval === true}
                label={t("community.groupSettings.approvalOnLabel")}
                onPress={() => {
              ...
              <ApprovalChip
                ...
                label={t("community.groupSettings.approvalOffLabel")}
                onPress={() => {
